...
import { useRecordMedicalFinding } from "@/hooks/use-transfers.hook";
...
export default function MedicalPage() {
  ...
  const reviewTransfer = transfers.find((transfer) => transfer.id === searchParams.get("transferId")) || null;
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-6 md:p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" onClick={() => setIsRecordModalOpen(true)} className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-xs font-semibold text-primary-foreground shadow-xs transition-colors hover:bg-primary-hover"><ClipboardPlus className="h-4 w-4" /> Record medical test</button>
      </div>
