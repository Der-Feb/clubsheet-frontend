    ...
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {FOLDERS.map((f) => (
            <div
              key={f.name}
              className="rounded-2xl border border-border bg-card p-4 shadow-xs hover:border-primary/40 transition-all cursor-pointer group text-card-foreground"
            >
              <div className="flex items-center justify-between">
                <Folder className="h-6 w-6 text-warning group-hover:text-primary transition-colors" />
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-card p-3 rounded-2xl border border-border shadow-xs text-card-foreground">
          ...
          <span className="text-xs text-muted-foreground">Showing recent uploads</span>
        </div>
